...
public abstract class ConsoleType extends ProductLabel
{
    ...
    */
    ...
    private void setProductionYear(String productionYear) { this.productionYear = productionYear; }
    private void setConsoleName(String consoleName) { this.consoleName = consoleName; }
